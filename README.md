...
Install the CLI tool to /usr/local/bin/kbd-rgb
Install the GUI to /usr/local/bin/kbd-rgb-gui
Install required dependencies for your distribution
Create sudoers rules for passwordless execution
...
Ensure ITE 8291 controller is present:
bash
...
Open an issue with the title "Support Request: [Your Laptop Model]" and include:
